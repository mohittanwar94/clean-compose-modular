...
class CommentItemTest {
    ...
    private val itemClick: (item: CommentModel) -> Unit = {}
    ...
    fun checkCommentExistOrNot() {
        ...
        composeRule.onNodeWithTag(listCommentItemCommentTag, useUnmergedTree = true).assertExists()
    ...
    fun checkNameExistOrNot() {
        composeRule.waitForIdle()
        composeRule.onNodeWithTag(listCommentItemNameTag, useUnmergedTree = true).assertExists()
    ...
    fun checkPostExistOrNot() {
        composeRule.waitForIdle()
        composeRule.onNodeWithTag(listCommentItemPostIDTag, useUnmergedTree = true).assertExists()
        composeRule.onNodeWithText(
            "post Id: $commentId"
        ).assertExists()
        composeRule.onNodeWithText(
